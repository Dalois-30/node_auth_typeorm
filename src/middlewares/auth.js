...
var user_model_1 = require("../modules/auth/models/user.model");
...
var AuthenticatedUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var accessToken, payload, user, e_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                payload = (0, jsonwebtoken_1.verify)(accessToken, "access_secret");
                ...
                return [4 /*yield*/, app_data_source_1.myDataSource.getRepository(user_model_1.User).findOneBy({
                        id: payload.id,
                    })];
            case 1:
                user = _b.sent();
